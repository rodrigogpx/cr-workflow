      ...
      <aside className="w-64 bg-black/80 text-white flex flex-col border-r border-white/10">
        <div className="px-4 py-3 border-b border-white/10 flex items-center gap-3">
          ...
          <div className="leading-tight text-xs">
            <p className="uppercase tracking-[0.25em] text-[0.6rem] text-white/50">
              Administração
            </p>
        ...
        <div className="px-4 py-3 border-b border-white/10 text-[0.7rem] flex items-center gap-2">
          ...
          <span
            className={`ml-auto text-[0.6rem] font-semibold px-1.5 py-0.5 rounded border ${roleClass}`}
          >
            {roleLabel}
          </span>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold truncate text-[0.78rem]">
                    {item.label}
                  </p>
                ...
                {item.enabled && (
                  <ChevronRight
                    className={`h-3 w-3 ${isActive ? "text-black" : "text-white/50"}`}
                  />
                )}
              </button>
            );
        ...
        <div className="max-w-5xl mx-auto space-y-4">
          <div className="flex items-center justify-between text-xs sm:text-sm text-white/70 mb-2">
            <div className="flex flex-col">
              <span className="uppercase tracking-[0.2em] text-white/40 text-[0.6rem]">
                Administração
              </span>
