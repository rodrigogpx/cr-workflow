...
const FEATURES: Feature[] = [
  {
    ...
    desc: "Etapas predefinidas do processo CAC com acompanhamento em tempo real por toda a equipe.",
  },
  {
    icon: "🗂️",
    title: "Juntada Digital",
    desc: "Upload e organização de documentos por nicho com validação automática e histórico completo.",
  },
  {
    icon: "👤",
    title: "Portal do Cliente",
    desc: "Acesso self-service para o associado acompanhar seu processo e enviar documentos diretamente.",
  },
  {
    icon: "📧",
    title: "Comunicação Integrada",
    desc: "Templates de email personalizáveis e notificações automáticas em cada etapa do processo.",
  },
  {
    icon: "📊",
    title: "Relatórios e Métricas",
    desc: "Dashboards com KPIs, prazo médio, taxa de conclusão e histórico de todos os processos.",
  },
  {
    icon: "🔒",
    title: "Segurança LGPD",
    desc: "Consentimento registrado, dados criptografados e controle de acesso granular por perfil.",
  },
];
...
const STEPS: Step[] = [
  {
    num: "01",
    title: "Cadastre o associado",
    desc: "Formulário com dados básicos, CPF e email. O sistema envia o convite automaticamente.",
  },
  {
    num: "02",
    title: "Acompanhe cada etapa",
    desc: "Workflow visual com subtarefas, checklist de documentos e status em tempo real.",
  },
  {
    num: "03",
    title: "Conclua no SINARM-CAC",
    desc: "Protocolo registrado, documentação digitalizada e histórico completo para auditoria.",
  },
];
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-16">
          ...
          <a href="#inicio" className="flex items-center gap-2">
            ...
            <span className="px-1.5 py-0.5 bg-[#F37321]/10 text-[#F37321] text-xs font-semibold rounded">
              beta
            </span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-gray-600">
            <a
              ...
              className="hover:text-[#123A63] transition-colors"
            >
              Funcionalidades
            </a>
            <a
            ...
            <a href="#demo" className="hover:text-[#123A63] transition-colors">
              Contato
            </a>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="hidden md:inline-flex items-center px-4 py-2 rounded-lg bg-[#123A63] text-white text-sm font-medium hover:bg-[#0e2d4e] transition-colors"
            >
              Acessar sistema
            </Link>
            <button
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-gray-100 bg-white px-4 py-3 space-y-2 text-sm">
            {["#funcionalidades", "#como-funciona", "#planos", "#demo"].map(
              (href, i) => (
                <a
                  key={href}
                  href={href}
            ...
            <Link
              href="/login"
              className="block w-full text-center py-2 rounded bg-[#123A63] text-white font-medium"
              onClick={() => setMenuOpen(false)}
            >
              Acessar sistema
            </Link>
      ...
      <section
        id="inicio"
        className="bg-gradient-to-br from-[#123A63] to-[#1a4f85] text-white py-20 px-4"
      >
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            ...
            documente tudo e mantenha sua equipe sincronizada — sem planilhas,
            sem papel.
          </p>
          ...
          <div className="mt-12 bg-white/10 rounded-2xl p-6 max-w-3xl mx-auto border border-white/20">
            <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
              {[
                ...
                <div
                  key={s}
                  className={`rounded-xl p-3 text-center text-xs font-medium ${i === 0 ? "bg-green-400/20 text-green-200 border border-green-400/30" : i <= 2 ? "bg-white/15 text-white/80" : "bg-white/5 text-white/40"}`}
                >
                  <div
                    className={`w-6 h-6 rounded-full mx-auto mb-1 flex items-center justify-center text-xs font-bold ${i === 0 ? "bg-green-400 text-green-900" : "bg-white/20"}`}
                  >
                    {i + 1}
                  </div>
                  {s}
      ...
      <section id="funcionalidades" className="py-20 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-[#123A63]">
              Tudo que seu clube precisa
            </h2>
            <p className="text-gray-500 mt-2">
              Uma plataforma completa para modernizar a gestão de processos CAC
            </p>
          </div>
      ...
      <section id="como-funciona" className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-2">
              Três passos simples para digitalizar seus processos CAC
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {PLANS.map(plan => (
              ...
              >
                ...
                <h3
                  className={`text-xl font-black mb-1 ${plan.highlight ? "text-white" : "text-[#123A63]"}`}
                >
                  {plan.name}
                </h3>
                ...
                <ul className="space-y-2 flex-1 mb-8">
                  {plan.features.map(f => (
                    <li
                      key={f}
                      className={`text-sm flex items-center gap-2 ${plan.highlight ? "text-white/90" : "text-gray-600"}`}
                    >
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {formState === "sent" ? (
            ...
            <form
              ...
              className="bg-gray-50 rounded-2xl border p-8 space-y-5"
            >
      ...
      <footer className="bg-[#123A63] text-white py-10 px-4">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div className="flex items-center gap-6 text-white/70">
            ...
            <a
              href="mailto:contato@cac360.com.br"
