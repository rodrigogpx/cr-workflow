...
export default function Users() {
  ...
  const [roleFilter, setRoleFilter] = useState<
    "all" | "admin" | "operator" | "despachante" | "pending"
  >("all");
      ...
      try {
        ...
        if (Array.isArray(parsed)) {
          const messages = parsed
            .map(item =>
              item && typeof item.message === "string" ? item.message : null
            )
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-3">
                <Select
                  ...
                  onValueChange={value =>
                    setRoleFilter(
                      value as "all" | "admin" | "operator" | "pending"
                    )
                  }
                >
      ...
      >
        <DialogContent>
          ...
          <form
            onSubmit={createForm.handleSubmit(handleSubmitCreate)}
            className="space-y-4"
          >
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={value =>
                  createForm.setValue(
                    "role",
                    value as "operator" | "admin" | "despachante"
                  )
                }
              >
                <SelectTrigger
                  className={
                    createForm.formState.errors.role ? "border-red-500" : ""
                  }
                >
          ...
          >
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger
                  className={
                    editForm.formState.errors.role ? "border-red-500" : ""
                  }
                >
                  <SelectValue placeholder="Selecione um perfil" />
                </SelectTrigger>
