...
> = {
  "Documento de Identificação Pessoal": {
    description:
      "RG, CNH ou outro documento oficial com foto. Deve estar dentro do prazo de validade.",
    issuer: "SSP (RG) · DETRAN (CNH) · Polícia Federal (Passaporte)",
  },
  "Certidão de Antecedente Criminal Justiça Federal": {
    description:
      "Comprova ausência de antecedentes na Justiça Federal. Gratuita e emitida online.",
    issuer: "Conselho da Justiça Federal (CJF)",
    obs: "Validade: 90 dias.",
    link: "https://certidao-unificada.cjf.jus.br/",
    linkLabel: "Emitir Certidão (CJF)",
  },
  "Certidão de Antecedente Criminal Justiça Estadual": {
    description:
      "Comprova ausência de antecedentes na Justiça Estadual. Deve conter distribuição e execução criminal.",
    issuer: "Tribunal de Justiça do Estado (TJ)",
    obs: "Validade: 90 dias. Consulte o TJ do seu estado.",
    link: "https://www.cnj.jus.br/certidao-negativa/",
    linkLabel: "Portal CNJ",
  },
  "Certidão de Antecedente Criminal Justiça Eleitoral": {
    description: "Certidão de crimes eleitorais emitida pelo TSE.",
    issuer: "Tribunal Superior Eleitoral (TSE)",
    obs: "Validade: 90 dias. Gratuita.",
    link: "https://www.tse.jus.br/eleitor/certidoes/certidao-de-crimes-eleitorais",
    linkLabel: "Emitir Certidão (TSE)",
  },
  "Certidão de Antecedente Criminal Justiça Militar": {
    description:
      "Comprova ausência de antecedentes na Justiça Militar Federal.",
    issuer: "Superior Tribunal Militar (STM)",
    obs: "Validade: 90 dias.",
    link: "https://www.stm.jus.br/servicos-stm/certidao-negativa",
    linkLabel: "Emitir Certidão (STM)",
  },
  "Declaração de não estar respondendo": {
    description:
      "Declaração formal afirmando que não responde a inquérito policial ou processo criminal.",
    issuer: "Gerada automaticamente pelo SisGCorp",
    link: "https://sisgcorp.eb.mil.br/#/solicitar-servico",
    linkLabel: "Acessar SisGCorp",
  },
  "Declaração de Segurança do Acervo": {
    description:
      "Declaração sobre condições de segurança do local onde as armas serão guardadas.",
    issuer: "Gerada automaticamente pelo SisGCorp",
    link: "https://sisgcorp.eb.mil.br/#/solicitar-servico",
    linkLabel: "Acessar SisGCorp",
  },
  "Declaração com compromisso de comprovar a habitualidade": {
    description:
      "Compromisso de comprovar habitualidade de prática de tiro. Exigido de atiradores desportivos.",
    issuer: "Declaração pessoal / Clube de tiro registrado",
    obs: "Dispensado para colecionadores.",
  },
  "Comprovante de Residência Fixa": {
    description:
      "Conta de luz, água, telefone ou contrato de aluguel, em nome do requerente, com no máximo 90 dias.",
    issuer: "Concessionárias de serviços públicos / Cartório",
  },
  "Comprovante de Ocupação Lícita": {
    description:
      "Comprova atividade profissional: CTPS, contracheque, declaração de autônomo ou pró-labore.",
    issuer: "Empregador / Contador / Órgão competente",
  },
  "Comprovante de Capacidade Técnica": {
    description:
      "Certificado de aprovação em teste de tiro emitido por instrutor credenciado pela PF.",
    issuer: "Instrutor credenciado pela PF / Clube de tiro",
    obs: "Custo estimado: R$ 170 a R$ 450.",
    link: "https://www.gov.br/pf/pt-br/assuntos/armas",
    linkLabel: "PF – Instrutores credenciados",
  },
  "Laudo de Aptidão Psicológica": {
    description:
      "Avaliação psicológica atestando aptidão para manuseio de arma de fogo.",
    issuer: "Psicólogo credenciado pela PF",
    obs: "Custo estimado: R$ 300 a R$ 800.",
    link: "https://www.gov.br/pf/pt-br/assuntos/armas/psicologos/psicologos-crediciados",
    linkLabel: "PF – Psicólogos credenciados",
  },
  "Comprovante de filiação a entidade de tiro desportivo": {
    description: "Documento do clube comprovando filiação ativa na modalidade.",
    issuer: "Clube de tiro desportivo registrado no Exército / CBATIRO",
    obs: "Dispensado para colecionamento.",
    link: "https://www.cbatiro.org.br",
    linkLabel: "CBATIRO",
  },
  "Comprovante de filiação a entidade de caça": {
    description:
      "Documento comprovando filiação ativa na modalidade de caça regulamentada.",
    issuer: "Associação de caça reconhecida",
    obs: "Dispensado para colecionamento.",
  },
  "Comprovante da necessidade de abate de fauna invasora": {
    description:
      "Autorização do IBAMA para controle de espécie invasora em propriedade rural.",
    issuer: "IBAMA",
  ...
  "Comprovante de Segundo Endereço": {
    description:
      "Comprovante de segundo endereço do requerente (imóvel de temporada, fazenda, sítio ou endereço comercial).",
...
export default function PortalDocumentos() {
  ...
  const sheetDocs = uploadedDocs.filter(d => {
    ...
    if (sheetFilter === "approved")
      return d.status === "approved" || d.status === "linked";
    return true;
  });
  ...
  const approvedCount = uploadedDocs.filter(
    d => d.status === "approved" || d.status === "linked"
  ).length;
  const progressPct =
    totalDocs > 0 ? Math.round((approvedCount / totalDocs) * 100) : 0;
      ...
      <Card className="mb-6 border border-gray-200 shadow-sm">
        <CardHeader className="pb-2">
          ...
          <p className="text-xs text-gray-500">
            Selecione o arquivo que deseja enviar ao operador
          </p>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <div
            ...
            onDrop={handleDrop}
            onClick={() =>
              uploadingIdx === null && fileInputRef.current?.click()
            }
          >
            <input
              ref={fileInputRef}
            ...
            <p className="text-xs text-gray-400 mt-1">
              PDF, JPG, PNG, Word — máximo 3 MB por arquivo
            </p>
          </div>
            ...
            <div className="space-y-1.5">
              {selectedFiles.map((file, idx) => (
                ...
                >
                  ...
                  {uploadingIdx === idx && (
                    <span className="text-xs text-blue-600 shrink-0 ml-2">
                      Enviando...
                    </span>
                  )}
                </div>
      ...
      {totalDocs > 0 && (
        <div className="mb-6 bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
          <p className="text-sm text-gray-700 mb-2">
            Documentos aprovados: <strong>{approvedCount}</strong> de{" "}
            <strong>{totalDocs}</strong> requisitos
          </p>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        >
          <p className="text-2xl font-bold text-amber-600">
            {
              uploadedDocs.filter((d: UploadedDoc) => d.status === "pending")
                .length
            }
          </p>
          ...
          <p className="text-2xl font-bold text-green-600">
            {
              uploadedDocs.filter(
                (d: UploadedDoc) =>
                  d.status === "approved" || d.status === "linked"
              ).length
            }
          </p>
            ...
            <div className="space-y-2">
              {sheetDocs.map((doc: UploadedDoc) => {
                ...
                return (
                  <div
                    key={doc.id}
                    className="flex flex-col gap-1 bg-gray-50 rounded-lg px-3 py-2.5 text-xs border border-gray-100"
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`flex-shrink-0 inline-flex items-center px-2 py-0.5 rounded-full font-medium ${cfg.className}`}
                      >
                        {cfg.label}
                      </span>
                    </div>
                    ...
                    {doc.status === "rejected" && doc.rejectionReason && (
                      <p className="text-red-500 italic pl-5 mt-0.5">
                        {doc.rejectionReason}
                      </p>
                    )}
                  </div>
