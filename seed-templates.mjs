...
const psicotecnicoTemplate = readFileSync(
  "./email-templates/psicotecnico.html",
  "utf8"
);
const laudoTecnicoTemplate = readFileSync(
  "./email-templates/laudo_tecnico.html",
  "utf8"
);
const juntadaDocumentosTemplate = readFileSync(
  "./email-templates/juntada_documentos.html",
  "utf8"
);
const psicotecnicoConcluidoTemplate = readFileSync(
  "./email-templates/psicotecnico_concluido.html",
  "utf8"
);
const laudoTecnicoConcluidoTemplate = readFileSync(
  "./email-templates/laudo_tecnico_concluido.html",
  "utf8"
);
const sinarmMontagemIniciadaTemplate = readFileSync(
  "./email-templates/sinarm_montagem_iniciada.html",
  "utf8"
);
const sinarmProtocoladoTemplate = readFileSync(
  "./email-templates/sinarm_protocolado.html",
  "utf8"
);
const sinarmAguardandoGruTemplate = readFileSync(
  "./email-templates/sinarm_aguardando_gru.html",
  "utf8"
);
const sinarmEmAnaliseTemplate = readFileSync(
  "./email-templates/sinarm_em_analise.html",
  "utf8"
);
const sinarmRestituidoTemplate = readFileSync(
  "./email-templates/sinarm_restituido.html",
  "utf8"
);
...
async function seedTemplates() {
  ...
  for (const template of templates) {
    try {
      ...
      console.error(
        `âŒ Erro ao processar template "${template.templateKey}":`,
        error.message
      );
    }
  }
