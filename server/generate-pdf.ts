...
export function generatePsychReferralPDF(
  ...
  return new Promise<Buffer>((resolve, reject) => {
    ...
    doc
      .fontSize(10)
      .fillColor("#555555")
      .text("Gestão de Workflow CR — Certificado de Registro", {
        align: "center",
      });
    doc.moveDown(0.3);
    ...
    doc
      .fontSize(14)
      .fillColor("#123A63")
      .text("ENCAMINHAMENTO PARA AVALIAÇÃO PSICOLÓGICA", { align: "center" });
    doc.moveDown(1.5);
    ...
    doc
      .fontSize(10)
      .fillColor("#555555")
      .text(`Emitido em: ${dateStr}`, { align: "right" });
    doc.moveDown(2);
    ...
    doc
      .fontSize(10)
      .fillColor("#000000")
      .text(`Assinatura / Responsável ${responsibleName}`, { align: "center" });
...
export function generateWelcomePDF(client: Client): Promise<Buffer> {
  return new Promise<Buffer>((resolve, reject) => {
    ...
    doc
      .fontSize(12)
      .fillColor("#000000")
      .text("Clube de Tiro Desportivo", { align: "center" });
    doc.moveDown(2);
    ...
    doc
      .fontSize(14)
      .fillColor("#000000")
      .text(`Olá, ${client.name}!`, { align: "left" });
    doc.moveDown(0.5);
    doc
      .fontSize(11)
      .text(
    ...
    doc
      .fontSize(14)
      .fillColor("#C41E3A")
      .text("O que é o Certificado de Registro (CR)?");
    doc.moveDown(0.5);
    doc
      .fontSize(11)
      .fillColor("#000000")
    ...
    doc
      .fontSize(10)
      .fillColor("#666666")
      .text("CAC 360 - Clube de Tiro Desportivo | www.firingrange.com.br", {
        align: "center",
      });
...
export function generateClientDataPDF(client: Client): Promise<Buffer> {
  return new Promise<Buffer>((resolve, reject) => {
    ...
    doc
      .fontSize(20)
      .fillColor("#1a5c00")
      .text("DADOS DO CADASTRO", { align: "center" });
    doc.moveDown(0.5);
    doc
      .fontSize(10)
      .fillColor("#666666")
    ...
    doc.text(
      `Data de Nascimento: ${client.birthDate ? new Date(client.birthDate).toLocaleDateString("pt-BR") : "-"}`
    );
    ...
    doc
      .fontSize(9)
      .fillColor("#999999")
      .text("Documento gerado automaticamente pelo sistema CAC 360", {
        align: "center",
      });
