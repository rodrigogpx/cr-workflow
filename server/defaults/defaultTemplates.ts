...
export const defaultEmailTemplates = rawTemplates.map(t => {
  ...
  switch(t.templateKey) {
    ...
    // ── Status Sinarm ────────────────────────────────────────────────────────
    case 'sinarm_iniciado':        subject = 'Montagem do Processo CAC Iniciada - {{nome}}';        title = 'Status Sinarm: Processo Iniciado';  break;
    case 'sinarm_solicitado':      subject = 'Seu Processo CAC foi Solicitado no Sinarm - {{nome}}'; title = 'Status Sinarm: Processo Solicitado'; break;
